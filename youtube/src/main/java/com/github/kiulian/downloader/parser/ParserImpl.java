...
public class ParserImpl implements Parser {
    ...
    private static String hlsurl = null;
    ...
    private VideoDetails parseVideoDetails(String videoId, JSONObject playerResponse) {
        ...
        //}
        if (playerResponse.containsKey("streamingData")) {
            String liveHLSUrl = playerResponse.getJSONObject("streamingData").getString("hlsManifestUrl");
            if (liveHLSUrl != null) hlsurl = liveHLSUrl;
            //System.err.println("Key [hlsManifestUrl] found:" + hlsurl);
        }

        return new VideoDetails(videoDetails, hlsurl);
