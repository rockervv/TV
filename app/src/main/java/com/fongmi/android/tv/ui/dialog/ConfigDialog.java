...
public class ConfigDialog extends BaseAlertDialog {
    ...
    protected void initView() {
        ...
        binding.positive.setText(ResUtil.getString(edit ? R.string.dialog_edit : R.string.dialog_positive));
    ...
    protected void initEvent() {
        ...
        binding.text.setOnFocusChangeListener((view, hasFocus) -> { if (hasFocus) append = true; });
