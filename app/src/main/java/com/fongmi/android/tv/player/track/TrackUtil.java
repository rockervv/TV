...
public class TrackUtil {
    ...
    public static void setTrackSelection(Player player, List<Track> tracks) {
        ...
        for (Map.Entry<Integer, TrackGroup> entry : mediaGroupMapByType.entrySet()) {
            int type = entry.getKey();
            TrackGroup mediaGroup = entry.getValue();
    ...
    private static class TrackInfo {
        ...
        int trackIndex;
        TrackInfo(Tracks.Group trackGroup, int trackIndex) {
