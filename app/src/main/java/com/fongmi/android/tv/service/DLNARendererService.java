    ...
    private void registerLocalDevice() {
        try {
            if (upnpService == null || upnpService.getRegistry() == null) {
                App.post(this::registerLocalDevice, 1000);
                return;
            }
